...
import com.jwebmp.plugins.aggrid.options.*;
...
public class AgGridModularOptionsExample
{
    ...
    private static void example1_BasicConfiguration()
    {
        ...
        System.out.println("Row Selection: " + gridOptions.getRowSelection());
    ...
    private static void example3_AdvancedFilter()
    {
        ...
        filter.setEnableAdvancedFilter(true)
    ...
    private static void example4_FluentChaining()
    {
        ...
        gridOptions.getServerSideRowModel()
        ...
        gridOptions.getAdvancedFilter()
            .setEnableAdvancedFilter(true)
            .setAdvancedFilterClassName("modern-filter");

        System.out.println("Configuration Complete!");
        System.out.println("Rendering Options:");
        System.out.println("  - Animate Rows: " + gridOptions.getRendering().getAnimateRows());
        System.out.println("  - Cell Flash Duration: " + gridOptions.getRendering().getCellFlashDuration());

        System.out.println("Server-Side Options:");
        System.out.println("  - Cache Block Size: " + gridOptions.getServerSideRowModel().getCacheBlockSize());
        System.out.println("  - Max Blocks in Cache: " + gridOptions.getServerSideRowModel().getMaxBlocksInCache());

        System.out.println("Advanced Filter Options:");
        System.out.println("  - Enabled: " + gridOptions.getAdvancedFilter().getEnableAdvancedFilter());
        System.out.println("  - Class Name: " + gridOptions.getAdvancedFilter().getAdvancedFilterClassName());
        System.out.println();
    }
    ...
    public static void example5_TypeSafeEnums()
    {
        ...
        options.setRowSelection(RowSelectionMode.MULTIPLE);    // ✅ Type-safe
