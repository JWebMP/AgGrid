...
public class AgGridModularCompositionExample
{
    ...
    public void example3_advancedFilter()
    {
        ...
        options.configureAdvancedFilter()
    ...
    public void example9_reuseableConfiguration()
    {
        ...
        standardRendering.setAnimateRows(true)
                        .setCellFlashDuration(500)
                        .setCellFadeDuration(300);
    ...
    public void example11_monolithicVsModular()
    {
        ...
        monolithic.configureRendering()
                  .setAnimateRows(true);
        monolithic.configureServerSideRowModel()
                  .setCacheBlockSize(100);
        monolithic.configureRowGrouping()
                  .setGroupDisplayType(GroupDisplayType.SINGLE_COLUMN.getJson());
        monolithic.configureRowPivoting()
                  .setPivotMode(true);
        
        // MODULAR APPROACH - AgGridOptions (@JsonUnwrapped composition)
        AgGridOptions<?> modular = new AgGridOptions<>();
        modular.configureRendering()
               .setAnimateRows(true);
        modular.configureServerSideRowModel()
               .setCacheBlockSize(100);
        modular.configureRowGrouping()
               .setGroupDisplayType(GroupDisplayType.SINGLE_COLUMN.getJson());
        modular.configureRowPivoting()
               .setPivotMode(true);
