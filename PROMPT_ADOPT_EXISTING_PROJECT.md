...
- Repository URL / local path: https://github.com/JWebMP/AgGrid
- Org and project name: JWebMP / AgGrid
- Short description: The JWebMP Plugin for the AgGrid / Angular Data Grid 
